...
$nA = array(array(8,2,22,97,38,15,0,40,0,75,4,5,7,78,52,12,50,77,91,8),
...
$dir = "Diagonally top-left bottom-right";
for($i=0;$i<=16;$i++)
{
	for($j=0;$j<=16;$j++)
	{
...
$dir = "Diagonally bottom-left top-right";
for($i=3;$i<=19;$i++)
{
	for($j=3;$j<=19;$j++)
	{
